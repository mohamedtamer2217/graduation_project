...
{
  static OutlineInputBorder textFormFieldOutlineInputBorder() => OutlineInputBorder(borderRadius: BorderRadius.circular(25), borderSide: const BorderSide(color: Colors.cyan, width: 3.5));
